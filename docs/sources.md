...
All reference links used across the knowledge base, organized by category.

## Community & Guides

- [BEFire — Getting Started Guide](https://www.reddit.com/r/BEFire/comments/fcbay6/getting_started_a_beginners_guide_to_investing_in/) — Comprehensive beginner's guide for Belgian investors (Reddit)
- [Curvo](https://curvo.eu/) — Belgian investing blog with broker comparisons, ETF analysis, and tax guides
- [Fire Belgium](https://www.firebelgium.be/) — Belgian FIRE community with broker and tax guides

## Brokers

- [Saxo Bank Belgium](https://www.home.saxo/en-be) — Danish broker operating in Belgium via BinckBank branch
- [Bolero (KBC)](https://www.bolero.be/) — KBC's online investment platform
- [DEGIRO](https://www.degiro.nl/) — Low-cost Dutch broker (Flatex subsidiary)
- [MeDirect Belgium](https://www.medirect.be/) — Belgian online bank with commission-free ETFs
...
- [tob.tax](https://tob.tax/) — Belgian TOB calculator with carry-forward rules and CGT details
- [PwC Belgium — Tax summaries](https://taxsummaries.pwc.com/belgium) — Professional tax reference for Belgian individual taxation
- [KBC Brussels — CGT explainer](https://www.kbcbrussels.be/) — Belgian broker guidance on CGT withholding

## Official

- [Belgian National Bank — Foreign account declaration](https://www.nbb.be/en) — Where foreign broker accounts must be declared
- [FOD Financien](https://financien.belgium.be/) — Belgian Federal Public Service Finance (official tax rules)
